...
OUTPUT_P="/Users/sudarshan/Documents/Jonathan/outputs/061924_1"
...
python3.8 tedana/workflows/sage/workflow_sage.py -d $ECHO1 $ECHO2 $ECHO3 $ECHO4 $ECHO5 -e $TE --out-dir $OUTPUT_P --mask-file-name $MASK
print_message "done."

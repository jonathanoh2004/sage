...
def denoise(
    ...
    if mixm is None:
        ...
        while keep_restarting:
            ...
            selector = tedana.selection.automatic_selection(
                comptable,
                selector,
                n_echos=n_echos,
                n_vols=n_vols,
            ...
            if (n_restarts < cmdline_args.maxrestart) and (n_likely_bold_comps == 0):
        ...
        if cmdline_args.ctab is None:
            ...
            comptable, metric_metadata = tedana.selection.automatic_selection(
